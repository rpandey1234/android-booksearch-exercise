...
3. Build an array of `Book` objects and notify the adapter that to display the new data. 
4. Define a view holder so the recycler view knows how to render each book. 
